...
;;; I don't think I need the above two lines since I'm using MELPA.
...
(autoload 'helm-ls-git-ls "helm-ls-git" nil t)
 ...
 ; helm-delete-minibuffer-contents-from-point t
  ...
  helm-boring-buffer-regexp-list '("*Help*" "*Completions*"))
 ...
 ;;; helm-buffer-map
 (define-key helm-buffer-map (kbd "C-x h") 'helm-quit-and-find-file)
